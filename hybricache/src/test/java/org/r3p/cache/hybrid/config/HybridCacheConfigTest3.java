...
@DirtiesContext
@ContextConfiguration(classes = {HybridCacheAppConfig3.class})
public class HybridCacheConfigTest3 extends BaseTest {
	...
	public void test() {
		...
		assertEquals(HybridCacheManager.CACHE_KEY, confList.get(2).getCacheName());
		assertEquals(HybridCacheManager.CACHE_COMMON, confList.get(3).getCacheName());
